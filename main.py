...
def sendWhatMsg():
    ...
    try:
        ...
        we.open("https://web.whatsapp.com/" +
...
def news():
    ...
    newsapi = NewsApiClient(api_key="1e9b5d00686d44bc8a29fef6db801896")
...
while True:
    ...
    if ("time" in query):
        ...
        os.startfile("C:\\Work Spaces\\"+inputCommand()+".code-workspace")
    elif("joke" in query):
